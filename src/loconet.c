/* $Id: loconet.c 1788 2024-02-19 06:57:33Z gscholz $ */
...
static int init_gl_LOCONET(gl_data_t *);
static int init_ga_LOCONET(ga_data_t *);
/**
 ...
 *
 */
static int init_gl_LOCONET(gl_data_t *gl)
{
 ...
 */
static int init_ga_LOCONET(ga_data_t *ga)
{
    return SRCP_OK;
}
